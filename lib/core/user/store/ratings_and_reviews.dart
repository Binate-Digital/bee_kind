...
class _RatingScreenState extends State<RatingScreen> {
  ...
  Widget build(BuildContext context) {
    final parsedAvgRating = widget.avgRating ?? 0.0;
    final parsedTotalReviews = widget.totalReviews ?? 0;
    final reviewList = widget.reviews ?? [];
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: CustomText(
                text: parsedAvgRating.toStringAsFixed(1),
                fontSize: 35.sp,
            ...
            CustomText(
              text: "$parsedTotalReviews Reviews",
              fontSize: 18.sp,
            ),
          ],
        ),
