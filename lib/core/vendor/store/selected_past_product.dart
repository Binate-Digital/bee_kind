        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.isCancelled) ...[
              ...
              // 🟨 Current Order → Stepper with 1 step active
              HorizontalStepper(currentStep: 0, steps: steps),
            ] else ...[
              // 🟩 Completed Order → Stepper fully completed
              HorizontalStepper(currentStep: steps.length - 1, steps: steps),
            ],
          ],
        ),
      ),
